        ...
        <div class='col-12 '>
            ...
            <div class="d-flex justify-content-center">
                <a href="https://volunteerists.herokuapp.com/" style={{
                    backgroundImage: `url('Volunteerist.gif')`, width: '40%', height: '280px', backgroundRepeat: 'no-repeat',
            ...
            <div class="d-flex justify-content-center">
                <a href="https://henry11244.github.io/letsTacoBoutFood/" style={{
                    backgroundImage: `url('LetsTacoBoutFood.gif')`, width: '40%', height: '280px', backgroundRepeat: 'no-repeat',
                    color: 'red', fontWeight: 'bold'
            ...
            <div class="d-flex justify-content-center">
                <a href="https://henry11244.github.io/WeatherDashboard/" style={{
                    backgroundImage: `url('WeatherDashBoard.gif')`, width: '40%', height: '280px', backgroundRepeat: 'no-repeat',
                    color: 'red', fontWeight: 'bold'
            ...
            <div class="d-flex justify-content-center">
                <a href="https://henry11244.github.io/WorkDayScheduler/"
                    style={{
                        backgroundImage: `url('WorkDayScheduler.gif')`, width: '40%', height: '280px', backgroundRepeat: 'no-repeat',
                        color: 'red', fontWeight: 'bold'
                    }}
            ...
            <div class="d-flex justify-content-center">
                <a href="https://henry-note-pad.herokuapp.com/"
                    style={{
                        backgroundImage: `url('NoteTaker.gif')`, width: '40%', height: '280px', backgroundRepeat: 'no-repeat',
                        color: 'red', fontWeight: 'bold'
                    }}
            ...
            <div class="d-flex justify-content-center">
                <a href="https://henry11244.github.io/JavaQuiz/"
                    style={{
                        backgroundImage: `url('JavaScript.gif')`, width: '40%', height: '280px', backgroundRepeat: 'no-repeat',
                        color: 'red', fontWeight: 'bold'
                    }}
